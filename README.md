...
이 저장소는 `README.md`, `DESIGN.md`, 그리고 공식 로고 자산을 보관하는 `assets/logos/` 폴더를 중심으로 운영한다.
...
AI에게 문서 작성을 요청할 때는 `DESIGN.md`를 기준으로 삼는다.

권장 요청 방식:

```text
VATOS Design System의 DESIGN.md 기준을 적용해서 작성해줘.

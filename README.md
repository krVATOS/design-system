...
| `assets/theme/Theme-Urban-Navy.png` | 문서 작성 시 기본 적용할 Urban Navy 테마 참고 이미지 |
| `specs/theme/document-theme-guide.md` | Word, PPT, Excel, HTML, Markdown 문서 작성 시 적용할 표지·내지·마무리 기본 테마 가이드 |
...
별도 디자인 요청이 없는 경우, 표지·내지·마무리 페이지의 기본 테마는 `specs/theme/document-theme-guide.md`와 `assets/theme/Theme-Urban-Navy.png`를 참고한다.
